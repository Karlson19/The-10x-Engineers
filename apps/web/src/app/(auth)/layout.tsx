  ...
  return (
    <AppProviders>
      <div className="flex min-h-dvh flex-col lg:grid lg:grid-cols-[5fr_6fr]">
        <aside className="paper-grain relative overflow-hidden bg-primary px-5 py-6 text-primary-foreground sm:px-8 lg:flex lg:flex-col lg:justify-between lg:px-12 lg:py-14">
          <Link
            href="/"
          ...
          <div className="relative z-10 mt-10 hidden max-w-md lg:mt-0 lg:block">
            <p className="font-mono text-xs tracking-[0.16em] text-primary-foreground/60 uppercase">
          ...
          <p className="relative z-10 mt-8 hidden font-mono text-xs tracking-[0.14em] text-primary-foreground/55 uppercase lg:mt-0 lg:block">
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -right-28 -bottom-32 hidden w-[26rem] text-primary-foreground opacity-[0.13] lg:block"
          >
            <StageDial />
          </div>
        </aside>
